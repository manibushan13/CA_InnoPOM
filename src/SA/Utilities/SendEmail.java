...
public class SendEmail {
	...
	public void sendEmailReport() throws InterruptedException {
		SMTP_SERVER = TestConfig.getGmailSendEmailHost();
		SMTP_SERVER_PORT = TestConfig.getSendEmailPort();
		USER_NAME = TestConfig.getSendEmailFrom();
		PASSWORD = TestConfig.getSendEmailPwd();
		from = TestConfig.getSendEmailFrom();
		to = TestConfig.getSendEmailTo();
